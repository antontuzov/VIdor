  ...
  theme: {
    extend: {
      ...
      backgroundImage: {
        ...
        'blue-gradient-subtle': 'linear-gradient(135deg, rgba(37, 99, 235, 0.1) 0%, rgba(14, 165, 233, 0.1) 50%, rgba(6, 182, 212, 0.1) 100%)',
      },
      
      // Shadows - Notion style (soft, diffused)
      boxShadow: {
        'none': '0 0 #0000',
        'xs': '0 1px 2px rgba(0, 0, 0, 0.03)',
        'sm': '0 1px 3px rgba(0, 0, 0, 0.05), 0 1px 2px rgba(0, 0, 0, 0.03)',
        'md': '0 4px 6px rgba(0, 0, 0, 0.05), 0 10px 15px rgba(0, 0, 0, 0.03)',
        'lg': '0 10px 15px rgba(0, 0, 0, 0.05), 0 20px 25px rgba(0, 0, 0, 0.04)',
        'xl': '0 20px 25px rgba(0, 0, 0, 0.05), 0 40px 50px rgba(0, 0, 0, 0.04)',
      ...
      animation: {
        ...
        'zoom-out': 'zoomOut 0.15s ease-out',
      },
      keyframes: {
        spin: {
